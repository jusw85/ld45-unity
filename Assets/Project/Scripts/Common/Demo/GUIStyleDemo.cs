...
public class GUIStyleDemoEditor : Editor
{
    private static readonly string[] Styles =
    {
        ...
        "scrollview", "AboutWIndowLicenseLabel", "AC BoldHeader", "AC Button", "AC ComponentButton", "AC GroupButton",
        ...
        "AM ToolbarObjectField", "AM TotalVuLabel", "AM VuValue", "AnimationEventBackground", "AnimationEventTooltip",
        ...
        "AvatarMappingErrorLabel", "AxisLabelNumberField", "Badge", "BoldLabel", "BoldToggle", "BottomShadowInwards",
        ...
        "ColorPickerBackground", "ColorPickerBox", "ColorPickerCurrentColor", "ColorPickerCurrentExposureSwatchBorder",
        "ColorPickerExposureSwatch", "ColorPickerHorizThumb", "ColorPickerHueRing", "ColorPickerHueRing HDR",
        "ColorPickerHueRingThumb", "ColorPickerOriginalColor", "ColorPickerSliderBackground", "Command", "CommandLeft",
        ...
        "dragtabdropwindow", "DropDown", "DropDownButton", "DropzoneStyle", "EditModeSingleButton", "EditModeToolbar",
        ...
        "flow node 5 on", "flow node 6", "flow node 6 on", "flow node base", "flow node hex 0", "flow node hex 0 on",
        ...
        "Icon.LockedBG", "Icon.Mute", "Icon.Options", "Icon.OutlineBorder", "Icon.PlayAreaEnd", "Icon.PlayAreaStart",
        ...
        "LODRendererButton", "LODRendererRemove", "LODRenderersText", "LODSceneText", "LODSliderBG", "LODSliderRange",
        "LODSliderRangeSelected", "LODSliderText", "LODSliderTextSelected", "MarkerItem", "MarkerMultiOverlay",
        "MeBlendBackground", "MeBlendPosition", "MeBlendTriangleLeft", "MeBlendTriangleRight", "MeLivePlayBackground",
        ...
        "MeTransitionHandleRight", "MeTransitionHead", "MeTransitionSelect", "MeTransitionSelectHead", "MeTransOff2On",
        ...
        "MiniMinMaxSliderHorizontal", "MiniMinMaxSliderVertical", "MiniPopup", "MiniPullDown", "MiniSliderHorizontal",
        ...
        "ObjectPickerPreviewBackground", "ObjectPickerResultsEven", "ObjectPickerResultsGrid", "ObjectPickerResultsOdd",
        ...
        "OL Minus", "OL Ping", "OL Plus", "OL ResultFocusMarker", "OL ResultLabel", "OL RightLabel", "OL SelectedRow",
        "OL Title", "OL Title TextRight", "OL Toggle", "OL ToggleMixed", "OL ToggleWhite", "OT BottomBar", "OT TopBar",
        "OverrideMargin", "PaneOptions", "PlayerSettingsLevel", "PlayerSettingsPlatform", "Popup", "PopupCurveDropdown",
        "PopupCurveEditorBackground", "PopupCurveEditorSwatch", "PopupCurveSwatchBackground", "PR BrokenPrefabLabel",
        ...
        "PreToolbar2", "PreVerticalScrollbar", "PreVerticalScrollbarThumb", "ProfilerBadge", "ProfilerGraphBackground",
        "ProfilerLeftPane", "ProfilerNoDataAvailable", "ProfilerPaneSubLabel", "ProfilerRightPane",
        "ProfilerScrollviewBackground", "ProfilerSelectedLabel", "ProfilerTimelineBar", "ProfilerTimelineDigDownArrow",
        ...
        "ProjectBrowserSubAssetBgOpenEnded", "ProjectBrowserSubAssetExpandBtn", "ProjectBrowserTextureIconDropShadow",
        ...
        "RectangleToolVBarBottom", "RectangleToolVBarTop", "RegionBg", "ReorderableList", "ReorderableListRightAligned",
        ...
        "TE NodeLabelTop", "TE PinLabel", "TE Toolbar", "TE toolbarbutton", "TE ToolbarDropDown", "TextFieldDropDown",
        "TextFieldDropDownText", "TimeAreaToolbar", "TimeScrubber", "TimeScrubberButton", "tinyFont", "TL InPoint",
        "TL OutPoint", "TL Playhead", "ToggleMixed", "Toolbar", "toolbarbutton", "ToolbarButtonFlat", "ToolbarDropDown",
        "ToolbarPopup", "ToolbarSeachCancelButton", "ToolbarSeachCancelButtonEmpty", "ToolbarSeachTextField",
        "ToolbarSeachTextFieldPopup", "ToolbarSearchField", "ToolbarTextField", "Tooltip", "TrackCollapseMarkerButton",
        ...
        "WindowBottomResize", "Wizard Box", "Wizard Error", "WordWrapLabel", "wordwrapminibutton", "WordWrappedLabel",
